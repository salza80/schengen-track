class Country
  ...
  field :old_schengen_calc, :boolean
  field :additional_visa_waiver, :boolean
  field :affiliate_booking_html, :string
  field :nationality, :string
  validates :country_code, :name, :continent, presence: true
