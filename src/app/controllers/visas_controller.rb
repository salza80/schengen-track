class VisasController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @visa.save
        format.html { redirect_to '/visits', notice: 'Visa was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @visa.update(visa_params)
        format.html { redirect_to '/visits', notice: 'Visa was successfully updated.' }
  ...
  def destroy
    @visa.destroy
    respond_to do |format|
      format.html { redirect_to '/visits', notice: 'Visa was successfully destroyed.' }
